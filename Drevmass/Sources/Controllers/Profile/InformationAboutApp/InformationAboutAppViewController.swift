...
class InformationAboutAppViewController: UIViewController {
    ...
    var arrowForCompanyButton: UIButton = {
       var button = UIButton()
        button.setImage(UIImage(resource: ImageResource.Profile.arrowBeigeProfile), for: .normal)
        button.addTarget(self, action: #selector(showAboutCompanyViewController), for: .touchUpInside)
        return button
    }()
    ...
    var YouTubeButton: UIButton = {
       var button = UIButton()
        button.setImage(UIImage(resource: ImageResource.Profile.iconYouTube), for: .normal)
    ...
    var VKButton: UIButton = {
       var button = UIButton()
        button.setImage(UIImage(resource: ImageResource.Profile.iconVK), for: .normal)
        button.contentMode = .scaleAspectFill
        button.clipsToBounds = true
        button.frame.size = CGSize(width: 64, height: 64)
