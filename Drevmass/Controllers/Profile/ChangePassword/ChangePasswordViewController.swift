...
//        textfield.addTarget(self, action: #selector(unlockSaveButton), for: .editingDidEnd)
    ...
    var showPasswordButton: UIButton = {
        var button = UIButton()
        button.setImage(.Registration.eye24, for: .normal)
        button.contentMode = .scaleAspectFill
...
extension ChangePasswordViewController {
    ...
    @objc func toggleNewShowButton() {
        ...
        if newPasswordTextfield.isSecureTextEntry == true {
            showNewPasswordButton.setImage(.Registration.eye24, for: .normal)
        }else{
            showNewPasswordButton.setImage(.Registration.eyeOff24, for: .normal)
        }
    }
    ...
    @objc func toggleShowButton() {
        ...
        if currentPasswordTextfield.isSecureTextEntry == true {
            showPasswordButton.setImage(.Registration.eye24, for: .normal)
        }else{
            showPasswordButton.setImage(.Registration.eyeOff24, for: .normal)
        }
    }
